...
input_dir = Path("/discover/nobackup/projects/QEFM/data/FMAifs/nc_files")
fmodel = "FMAifs"
yyyy = args.year
mm = args.month
dd = args.day
...
ds = ds.rename({'level': 'lev', 'latitude': 'lat', 'longitude': 'lon'})
...
rename_dict = {
    ...
    "2m_temperature": "T2M",
    "2m_dewpoint_temperature": "T2MDEW",
    "mean_sea_level_pressure": "SLP",
    "skin_temperature": "TS",
    "surface_pressure" : "PS",
    "total_column_water" : "TQL",
