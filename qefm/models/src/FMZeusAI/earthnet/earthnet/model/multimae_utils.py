...
def build_3d_sincos_posemb(h, w, t, embed_dim=768, temperature=10000.0):
    """
    3D Sine-cosine positional embeddings
    """
    grid_w = torch.arange(w, dtype=torch.float32)
    grid_h = torch.arange(h, dtype=torch.float32)
    ...
    pos_emb = rearrange(pos_emb, "b (t h w) d -> b d t h w", h=h, w=w, d=embed_dim, t=t)
    return pos_emb
