...
if __name__ == "__main__":
    config_file = "multimodal_earth_small.yaml"
    ...
    plt.savefig("goes16_Rad_small.png")

    # Save the plot with higher DPI and tight bounding box
    plt.savefig("goes16_Rad_small_highres.png", dpi=300, bbox_inches='tight')
