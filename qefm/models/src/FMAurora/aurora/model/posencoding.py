...
#GST from timm.models.layers.helpers import to_2tuple
...
def pos_scale_enc_grid(
    ...
    Args:
        ...
        pos_expansion (:class:`FMAurora.model.fourier.FourierExpansion`): Fourier expansion for the
            latitudes and longitudes.
        scale_expansion (:class:`FMAurora.model.fourier.FourierExpansion`): Fourier expansion for the
            patch areas.
