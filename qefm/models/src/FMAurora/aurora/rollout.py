...
def rollout(model: Aurora, batch: Batch, steps: int) -> Generator[Batch, None, None]:
    ...
    Args:
        model (:class:`FMAurora.model.FMAurora.Aurora`): The model to roll out.
        batch (:class:`FMAurora.batch.Batch`): The batch to start the roll-out from.
        steps (int): The number of roll-out steps.

    Yields:
        :class:`FMAurora.batch.Batch`: The prediction after every step.
    """
