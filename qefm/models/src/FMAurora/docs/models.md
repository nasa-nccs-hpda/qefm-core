...
model.load_checkpoint("microsoft/FMAurora", "FMAurora-0.25-pretrained.ckpt")
```
...
model = Aurora()
model.load_checkpoint("microsoft/FMAurora", "FMAurora-0.25-finetuned.ckpt")
```
...
model.load_checkpoint("microsoft/FMAurora", "FMAurora-0.25-finetuned.ckpt", strict=False)
```
...
model = AuroraHighRes()
model.load_checkpoint("microsoft/FMAurora", "FMAurora-0.1-finetuned.ckpt")
```
...
model.load_checkpoint("microsoft/FMAurora", "FMAurora-0.1-finetuned.ckpt", strict=False)
```
