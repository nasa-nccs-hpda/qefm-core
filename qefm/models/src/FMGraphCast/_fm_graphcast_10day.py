...
parser.add_argument("--indir", "-id", default="/explore/nobackup/projects/ilab/projects/QEFM/data/FMGraphCast/sim/", type=str, help="ERA5 subsetted source directory")
parser.add_argument("--outdir", "-o", default="/explore/nobackup/projects/ilab/projects/QEFM/data/FMGraphCast/rollout_outputs/10day", type=str, help="Graphcast Rolllout Output directory")
