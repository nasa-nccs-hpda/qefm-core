...
#'../model/params/params_GraphCast_small - ERA5 1979-2015 - resolution 1.0 - pressure levels 13 - mesh 2to5 - precipitation input and output.npz'
#with open(f’../model/params/params_GraphCast_small - ERA5 1979-2015 - resolution 1.0 - pressure levels 13 - mesh 2to5 - precipitation input and output.npz', 'rb') as model:
...
#with open(r'../model/params/params_GraphCast_small - ERA5 1979-2015 - resolution 1.0 - pressure levels 13 - mesh 2to5 - precipitation input and output.npz', 'rb') as model:
...
#../model/stats/stats_diffs_stddev_by_level.nc
...
def getSingleAndPressureValues():
    ...
    #)'''
    singlelevel = xarray.open_dataset('single-level.nc', engine="netcdf4").to_dataframe()
