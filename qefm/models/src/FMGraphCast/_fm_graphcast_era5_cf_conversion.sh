...
for DD in {01..31}; do
    cmd="python /discover/nobackup/projects/QEFM/qefm-core/qefm/models/src/FMGraphCast/_graphcast_cf_init.py --year "$YYYY" --month "$MM" --day "$DD" --indir /discover/nobackup/projects/QEFM/data/FMGraphCast/rollout_outputs/v20250815 --outdir /discover/nobackup/projects/QEFM/data/FMGraphCast/rollout_outputs/v20250815/cf "
    ...
    echo $fm: $cmd
    $cmd    
    cmd="python /discover/nobackup/projects/QEFM/qefm-core/qefm/models/src/FMGraphCast/_graphcast_cf.py --year "$YYYY" --month "$MM" --day "$DD" --indir /discover/nobackup/projects/QEFM/data/FMGraphCast/rollout_outputs/v20250815 --outdir /discover/nobackup/projects/QEFM/data/FMGraphCast/rollout_outputs/v20250815/cf "
